...
function peg$parse(input, options) {
  ...
  var peg$e33 = peg$literalExpectation("nullUnit", false);
  ...
  var peg$f22 = function(node) {
    return node
  };
  var peg$f23 = function(func, list) {
    return {
      nodeType: 'func_call',
      func,
      params: list || [],
  ...
  var peg$f24 = function(arr, index) {
    return {
      nodeType: 'arr_index',
      arr,
      index,
  ...
  var peg$f25 = function(obj, member) {
    return {
      nodeType: 'obj_member',
      obj,
      member,
